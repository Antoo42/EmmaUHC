 ...
 * @author Blendman974
 */
public class KInventory implements fr.blendman974.kinventory.inventories.ContainerElement {

    private final Map<Integer, fr.blendman974.kinventory.inventories.ContainerElement> content = new HashMap<>();
    private final PropertyChangeSupport containerInventorySupport;
    private final PropertyChangeSupport itemEventPoll;
    private final List<fr.blendman974.kinventory.inventories.KInventoryRepresentation> representations = new ArrayList<>();
    private Consumer<Player> closeConsumer = null;
    private fr.blendman974.kinventory.inventories.KItem itemRepresentation;
    private Function<Player, String> nameFunction;

    private fr.blendman974.kinventory.inventories.KInventoryType type;

    public KInventory(fr.blendman974.kinventory.inventories.KItem item, fr.blendman974.kinventory.inventories.KInventoryType type, Function<Player, String> nameFunction) {
    ...
    public KInventory(fr.blendman974.kinventory.inventories.KInventoryType type, Function<Player, String> nameFunction) {
        this(fr.blendman974.kinventory.inventories.KItem.DEFAULT, type, nameFunction);
    }

    public KInventory(fr.blendman974.kinventory.inventories.KItem item, KInventoryType type, String name) {
        this(item, type, player -> name);
    }

    public KInventory(fr.blendman974.kinventory.inventories.KInventoryType type, String name) {
        this(fr.blendman974.kinventory.inventories.KItem.DEFAULT, type, player -> name);
    }

    public KInventory(fr.blendman974.kinventory.inventories.KItem item, InventoryType type, Function<Player, String> nameFunction) {
        this(item, new fr.blendman974.kinventory.inventories.KInventoryType(type), nameFunction);
    }

    public KInventory(InventoryType type, Function<Player, String> nameFunction) {
        this(fr.blendman974.kinventory.inventories.KItem.DEFAULT, new fr.blendman974.kinventory.inventories.KInventoryType(type), nameFunction);
    }

    public KInventory(fr.blendman974.kinventory.inventories.KItem item, InventoryType type, String name) {
