...
public class TCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String s, String[] strings) {
        ...
        UHC.getInstance().getUhcGame().getUhcData().getUhcPlayerList().stream().filter(uhcPlayer1 -> uhcPlayer1.getRole() instanceof TRole && ((TRole) uhcPlayer1.getRole()).getTaupeTeam() == ((TRole) uhcPlayer.getRole()).getTaupeTeam() && !(uhcPlayer.getRole() instanceof SuperTaupe)).forEach(uhcPlayer1 -> {
